...
Rev.3 2014.01.21 Add photo sensor  R-G-B-R-G-B
*/
...
PROGMEM const unsigned short rfHeartbeatTimeout = 3000; //mS
...
void setup(){
  ...
  brinkRgbLed(30,0,0,10,100,50);
  brinkRgbLed(0,20,0,10,100,50);
  brinkRgbLed(0,0,20,10,100,50);
  brinkRgbLed(30,0,0,10,100,50);
  brinkRgbLed(0,20,0,10,100,50);
  brinkRgbLed(0,0,20,10,100,50);
}
